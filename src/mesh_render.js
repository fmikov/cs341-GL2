		...
		*/
		...
		for( const actor of scene_info.actors ) {
			...
			*/
			...
			this.mat_model_view = mat4.multiply(mat_model_view, mat_view, actor.mat_model_to_world);

			this.mat_normals_to_view = mat3.normalFromMat4(mat3.create(), mat_model_view);
